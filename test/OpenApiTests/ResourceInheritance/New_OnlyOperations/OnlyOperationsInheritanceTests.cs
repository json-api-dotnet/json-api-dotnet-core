...
public sealed class OnlyOperationsInheritanceTests : ResourceInheritanceTests
{
        ...
        : base(testContext, true)
    {
        ...
        {
            services.AddSingleton<IJsonApiEndpointFilter, OnlyOperationsEndpointFilter>();
            services.AddSingleton<IAtomicOperationFilter, OnlyOperationsOperationFilter>();
        });
    }
    ...
    [InlineData("identifierInRequest", false, "bathrooms|bedrooms|kitchens|livingRooms|toilets|rooms|familyHomes|mansions|residences|buildings|districts|roads|cyclePaths|staffMembers")]
    ...
    [InlineData("attributesInBuildingResponse", true, null, "surfaceInSquareMeters|openapi:discriminator")]
    ...
    [InlineData("relationshipsInBuildingResponse", true, null, "openapi:discriminator")]
    ...
    [InlineData("attributesInRoomResponse", true, null, "surfaceInSquareMeters|openapi:discriminator")]
    ...
    [InlineData("relationshipsInRoomResponse", true, null, "residence|openapi:discriminator")]
    ...
    [InlineData("attributesInRoadResponse", false, null, "lengthInMeters|openapi:discriminator")]
    ...
    [InlineData("relationshipsInRoadResponse", false, null, "openapi:discriminator")]
