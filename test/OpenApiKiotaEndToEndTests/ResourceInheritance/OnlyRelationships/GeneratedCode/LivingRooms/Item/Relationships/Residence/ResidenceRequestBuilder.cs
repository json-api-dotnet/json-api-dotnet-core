...
using System;
namespace OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence
{
    /// <summary>
    /// Builds and executes requests for operations under \livingRooms\{id}\relationships\residence
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ResidenceRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence.ResidenceRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResidenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/livingRooms/{id}/relationships/residence{?query*}", pathParameters)
        {
        }
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResidenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/livingRooms/{id}/relationships/residence{?query*}", rawUrl)
        {
        }

        /// <summary>
        /// Retrieves the related residence identity of an individual livingRoom&apos;s residence relationship.
        /// </summary>
        ...
        /// <summary>
        /// Assigns an existing residence to the residence relationship of an individual livingRoom.
        /// </summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence.ResidenceRequestBuilder.ResidenceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
        ...
        /// <returns>A <see cref="RequestInformation"/></returns>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence.ResidenceRequestBuilder.ResidenceRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence.ResidenceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence.ResidenceRequestBuilder WithUrl(string rawUrl)
        {
            return new global::OpenApiKiotaEndToEndTests.ResourceInheritance.OnlyRelationships.GeneratedCode.LivingRooms.Item.Relationships.Residence.ResidenceRequestBuilder(rawUrl, RequestAdapter);
        }
